...
router.get('/count-lesion-part1', (req, res) => {
    ...
    .where((builder) => {
        ...
        if (req.query['others']) builder.orWhere('part1.lesion_others_a', true).orWhere('part1.lesion_pothers_b', true)
    })
    .orderBy('part1.patient_code', 'asc')
    .returning()
    .then((data) => res.json(data))
...
router.get('/count-lesion-part4', (req, res) => {
    ...
    .where((builder) => {
        ...
        if (req.query['others']) builder.orWhere('part4.lesion_others_a', true).orWhere('part4.lesion_pothers_b', true)
    })
    .orderBy('part1.patient_code', 'asc')
    .returning()
    .then((data) => res.json(data))
